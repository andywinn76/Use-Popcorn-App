...
/*
//This effect triggers only at the initial render, displaying on console second in this example.
useEffect(function() {
  console.log("After initial render.");
}, []);
//This effect triggers after every single render, showing last because it's second in line after the above effect.
useEffect(function() {
  console.log("After every render.");
});
//This happens during mounting and every time you type something into the search bar because query state changes with each button press.
useEffect(function() {
  console.log("D")
}, [query]);
//This happens during render, displaying first on the console.
...
useEffect(function() {
  ...
  async function fetchMovies() {
    ...
    //Cleanup function
    return function() {
      //Each time there is a new keystroke in movie search bar, controller will abort the fetch request
      controller.abort();  
    }
  }, [query]);
